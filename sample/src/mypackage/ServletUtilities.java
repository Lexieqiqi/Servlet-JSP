...
public class ServletUtilities
{
   ...
   /**
    * Read a parameter with the specified name, convert it to an int, and return it. Return the
    * designated default value if the parameter doesn't exist or if it is an illegal integer format.
    */
    ...
    * the cookie with the given name. If there is no cookie matching the name in the array, then the
    ...
    * array that has the given name. If there is no cookie matching the name in the array, null is
    * returned.
    */
